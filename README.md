...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-02-14 10:24`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/3e928e74-b051-40c0-9dae-b8a5317dac7e.git
$ cd 3e928e74-b051-40c0-9dae-b8a5317dac7e
```
